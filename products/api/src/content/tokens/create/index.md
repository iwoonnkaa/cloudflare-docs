...
To get started creating an API Token, log into the [Cloudflare Dacurl -X GET "https://api.cloudflare.com/client/v4/user/tokens/verify" \
     -H "Authorization: Bearer UKKQZalARqUORDNSr_lNHaa5yGeasL2njnvDLBxk" \
     -H "Content-Type:application/json"
shboard](https://dash.cloudflare.com) and go to `User Profile` -> `API Tokens` or simply [click here](https://dash.cloudflare.com/profile/api-tokens). From the API Token home screen select `Create Token`.
